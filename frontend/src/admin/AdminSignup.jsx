      ...
      <div className="h-screen text-white container mx-auto flex items-center justify-center py-6">
        ...
        <header className=" absolute top-0 left-0 w-full flex items-center justify-between ">
          ...
          <div className="space-x-4">
            ...
            <Link
              to={"/courses"}
              className="bg-orange-500 text-white px-4 py-2 border border-white rounded hover:bg-white hover:text-black font-bold"
            >
              Join Now
            </Link>
          </div>
        ...
        <div className="bg-gray-900 p-8 rounded-lg shadow-lg w-[500px] mt-20">
          ...
          <p className="text-center text-gray-400 mb-2">Just Signup to mess with dashboard!</p>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <button type="submit" className="w-full bg-orange-500 text-white py-3 px-6 rounded-md transition hover:bg-blue-500">SignUp</button>
          </form>
        </div>
      </div>
    </div>
