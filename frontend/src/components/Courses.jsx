    ...
    <div className="flex">
        ...
        <aside className='w-64 bg-gray-100 h-screen p-5 fixed'>
            <div className='flex items-center mb-10'>
                <img src={logo} alt='profile' className='rounded-full h-12 w-12'></img>
            </div>
      ...
      <header className='flex justify-between items-center mb-10'>
        ...
        <div className="flex items-center space-x-3">
            <div className="flex items-center">
                <input type='text' placeholder='type here to search' className='border border-gray-300 rounded-l-full px-4 py-2 focus:outline-none'></input>
            ...
            <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6">
                {courses.map((course)=>(
                    ...
                    className="border border-grey-200 rounded-lg p-4 shadow-sm">
                        <img src={course.image.url} alt={course.title} className='rounded mb-4'></img>
